...
for (let i = 0; i < COLS * ROWS; i++) {
 ...
 CARDS_DATA.push({
   ...
   author: ["スタジオジブリ風", "新海誠スタイル", "鳥山明リسپেক트", "手塚治虫오마쥬"][Math.floor(Math.random() * 4)],
